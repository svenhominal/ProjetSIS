...
#define THRESHOLD_BRAITENBERG 790
...
void braitenberg(double* ps, double &vel_left, double &vel_right){
    ...
    double coefficients[16][2] =
    {{-0.4, 1.1},{-0.5,1.3},{-0.7,1.4}, // 0 1 2
    {-1, 1.6},{2,-1.2}, // 3 4
    {1.4,-0.8},{1.1, -0.3},{1.1,-0.1}, // 5 6 7
    {0.2,-0.1},{-0, -0},{-0,-0}, // 8 9 10
    {-0,-0},{-0, -0}, // 11 12
    {-0,-0},{-0,-0},
    {-0.1,0.2} }; // 13 14 15 
    ...
    /*double coefficients[16][2] =
    {{0.1, 0.5},{-0.4,0.6},{-0.3,0.9}, // 0 1 2
    {-0.5, -0.5},{-0.5,-0.5}, // 3 4
    {1.3,-0.2},{1.1, -0.8},{0.5,0.1}, // 5 6 7
    ...
    */ 
    ...
    /*double coefficients[16][2] =
    {{-0.4, 0.4},{-0.3,0.9},{-0.2,1.6},// 0 1 2
    {-0.2, 1.6},{1.4,-0.35},   // 3 4
    {1.1,-0.15},{0.9, -0.1},{0.8,0.7},// 5 6 7
    {0,0},{0, 0},{0,0}, // 8 9 10
    {0,0}, {0, 0}, // 11 12
    ...
    */
    ...
    for (int i = 0; i<NB_SENSORS;i++){
        if (ps[i] < THRESHOLD_BRAITENBERG){
            ps[i] = THRESHOLD_BRAITENBERG;
        }
